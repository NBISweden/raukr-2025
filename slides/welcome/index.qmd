...
## NBIS: SciLifeLab Bioinformatics Platform {background-image="assets/bioinformatics-platform.webp"}

## {background-image="assets/core-activities.webp"}

## Support stages {background-image="assets/support-stages.webp"}

## Support options {background-image="assets/support-options.webp"}

## Infrastructure {background-image="assets/infrastructure.webp"}

## Training {background-image="assets/training.webp"}
