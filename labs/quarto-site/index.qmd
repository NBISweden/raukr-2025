...
First we need to make sure that the `docs` directory is set as the source for GitHub Pages. Go to the settings of your repository on GitHub, scroll down to the "Pages" section, and select the `docs` directory as the source. Then click "Save". This will enable GitHub Pages for your repository and set the `docs` directory as the source for the website.

![Setup GitHub pages](assets/gh-pages-docs.webp){#fig-gh-docs}

Stage and commit all changes locally, then push the changes to the remote repository on GitHub.
...
[[Elizabeth McDaniel]{.btn .btn-sm .btn-secondary}](https://elizabethmcdaniel.com/)
[[Dan Yavorsky]{.btn .btn-sm .btn-secondary}](https://www.danyavorsky.com/)
[[Kelly Sovacool]{.btn .btn-sm .btn-secondary}](https://sovacool.dev/)
[[Simon Couch]{.btn .btn-sm .btn-secondary}](https://www.simonpcouch.com/)
[[Katherine Hayes]{.btn .btn-sm .btn-secondary}](https://krhayes.com/)
[[Katherine Hoffman]{.btn .btn-sm .btn-secondary}](https://www.khstats.com/)
[[Beatriz Milz]{.btn .btn-sm .btn-secondary}](https://beamilz.com/)
[[Emil Hvitfeldt]{.btn .btn-sm .btn-secondary}](https://emilhvitfeldt.com/)
[[Thomas Mock]{.btn .btn-sm .btn-secondary}](https://themockup.blog/)
[[Alex Hayes]{.btn .btn-sm .btn-secondary}](https://www.alexpghayes.com/)
[[Jesse Sadler]{.btn .btn-sm .btn-secondary}](https://www.jessesadler.com/)
[[Fabrício Almeida-Silva]{.btn .btn-sm .btn-secondary}](https://almeidasilvaf.github.io/)
[[Cynthia Huang]{.btn .btn-sm .btn-secondary}](https://www.cynthiahqy.com/)
[[Megan Harris]{.btn .btn-sm .btn-secondary}](https://thetidytrekker.com/)
[[Javier Orraca-deatcu]{.btn .btn-sm .btn-secondary}](https://www.javierorracadeatcu.com/)
[[Isabella Velásquez]{.btn .btn-sm .btn-secondary}](https://ivelasq.rbind.io/)
[[Joel Nitta]{.btn .btn-sm .btn-secondary}](https://www.joelnitta.com/)
[[Daniel Navarro]{.btn .btn-sm .btn-secondary}](https://djnavarro.net/)
[[Zeki Akyol]{.btn .btn-sm .btn-secondary}](https://zekiakyol.com/)
[[Ben Ewing]{.btn .btn-sm .btn-secondary}](https://improperprior.com/)
[[Introduction to Nonprofits]{.btn .btn-sm .btn-secondary}](https://nonprofitf22.classes.andrewheiss.com/)
[[Bioconductor community blog]{.btn .btn-sm .btn-secondary}](https://blog.bioconductor.org/)
[[Journal of visualization & Interaction]{.btn .btn-sm .btn-secondary}](https://www.journalovi.org/)
...
[[John Helveston]{.btn .btn-sm .btn-secondary}](https://www.jhelvy.com/)
[[Silvia Canelon]{.btn .btn-sm .btn-secondary}](https://silviacanelon.com/)
[[Andrew Heiss]{.btn .btn-sm .btn-secondary}](https://www.andrewheiss.com/)
[[Arthur Turrell]{.btn .btn-sm .btn-secondary}](https://aeturrell.com/)
[[Deep Policy Lab]{.btn .btn-sm .btn-secondary}](https://deeppolicylab.github.io)
[[Gang He]{.btn .btn-sm .btn-secondary}](https://drganghe.github.io/)
[[Robert Michelle]{.btn .btn-sm .btn-secondary}](https://robertmitchellv.com/)
[[Dax Kellie]{.btn .btn-sm .btn-secondary}](https://daxkellie.com/)
[[Crump Lab]{.btn .btn-sm .btn-secondary}](https://www.crumplab.com/)
[[Jadey Ryan]{.btn .btn-sm .btn-secondary}](https://jadeyryan.com/)
[[Aster Hu]{.btn .btn-sm .btn-secondary}](https://www.asterhu.com/)
[[Megan Hall]{.btn .btn-sm .btn-secondary}](https://meghan.rbind.io/)
[[Sam Shanny-Csik]{.btn .btn-sm .btn-secondary}](https://samanthacsik.github.io/)
[[Mickaël Canouil]{.btn .btn-sm .btn-secondary}](https://mickael.canouil.fr/)
[[Nick Lyon]{.btn .btn-sm .btn-secondary}](https://njlyon0.github.io/)
[[Data viz with R]{.btn .btn-sm .btn-secondary}](https://datavizs23.classes.andrewheiss.com/)
[[Uni Cambridge Course template]{.btn .btn-sm .btn-secondary}](https://cambiotraining.github.io/quarto-course-template/)
...
[[Masiello Lab]{.btn .btn-sm .btn-secondary}](https://faculty.washington.edu/masiello/)
[[Ella Kaye]{.btn .btn-sm .btn-secondary}](https://ellakaye.co.uk/)
[[Real world data science]{.btn .btn-sm .btn-secondary}](https://realworlddatascience.net/)
[[R for the rest of us]{.btn .btn-sm .btn-secondary}](https://rfortherestofus.com/)
[[Quantum Jitter]{.btn .btn-sm .btn-secondary}](https://www.quantumjitter.com/)
[[Tidymodels]{.btn .btn-sm .btn-secondary}](https://www.tidymodels.org/)
[[Possible institute]{.btn .btn-sm .btn-secondary}](https://possible.institute/)
